...
<div class="row">
    ...
    <div class="col-lg-{{ $div_col }} mb-10 overflow-auto draggable-zone" id="{{ $id }}_preview">
        @php
        ...
        @if ($oldIds != null)
            @for ($i = 0; $i < count($oldIds); $i++)
                <div class="symbol symbol-150px mb-5 me-5 overlay min-h-175px w-175px draggable">
                    ...
                    <a class="col symbol symbol-150px mb-5 me-5 overlay min-h-175px w-175px"
                        ...
                        <div class="overlay-layer card-rounded bg-dark bg-opacity-25 shadow"><i
                                class="bi bi-eye-fill text-white fs-3x draggable-handle"></i></div>
    ...
    var {{ $id }}imageDropzone = new Dropzone("#{{ $id }}_drop", {
        ...
        success: function(file, responseText) {
            ...
            var image =
                ...
                imagePath + ')"></div>' +
                '<div class="overlay-layer card-rounded bg-dark bg-opacity-25 shadow"><i class="bi bi-eye-fill text-white fs-3x draggable-handle"></i></div></a><a onClick="removeImage(this)" class="col-lg-12 btn btn-light-danger">삭제</a></div>'
