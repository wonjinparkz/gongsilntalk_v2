...
<div class="modal_slide modal_slide_filter_3">
    ...
    <div class="filter_panel_bottom">
        <button type="button" class="btn_graylight_ghost btn_md_full"
            onclick="modal_close_slide('filter_3'); filter_reset('product_type')"><img
                src="{{ asset('assets/media/ic_refresh.png') }}">초기화</button>
        <button type="button" class="btn_point btn_md_full"
            onclick="modal_close_slide('filter_3'); filter_apply('product_type', 0)">적용하기</button>
    </div>
</div>
<div class="md_slide_overlay md_slide_overlay_filter_3" onclick="modal_close_slide('filter_3')"></div>
<script>
