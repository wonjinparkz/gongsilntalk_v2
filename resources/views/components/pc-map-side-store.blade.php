...
<div class="map_side_body">
    <div class="side_header">
        ...
        <div class="m_title">{{ $result->kstoreName }}</div>
        ...
        <div class="layer layer_share_wrap layer_share_top">
            ...
            <div class="layer_share_con">
                <a class="kakaotalk-sharing-btn" onclick="modal_close_slide('share');"
                    ...
                    data-m_link="{{ route('www.map.mobile', ['markerId' => $result->id, 'markerType' => 'store', 'lat' => $result->address_lat, 'lng' => $result->address_lng]) }}"
                    data-pc_link="{{ route('www.map.map', ['markerId' => $result->id, 'markerType' => 'store', 'lat' => $result->address_lat, 'lng' => $result->address_lng]) }}">
                    <img src="{{ asset('assets/media/share_ic_01.png') }}">
                    <p class="mt8">카카오톡</p>
                </a>
                <a
                    onclick="textCopy('{{ route('www.map.map', ['markerId' => $result->id, 'markerType' => 'store', 'lat' => $result->address_lat, 'lng' => $result->address_lng]) }}'); modal_close_slide('share');">
    ...
    <div class="scroll_wrap_1">
        ...
        <div class="side_info_wrap">
            ...
            <p class="txt_sub_1">{{ $result->subwayStation }} {{ $result->subwayLine }}
                <span>{{ $result->kstoredWtimesub }}</span>
            </p>
