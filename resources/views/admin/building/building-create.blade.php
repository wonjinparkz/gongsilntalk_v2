                    ...
                    <div class="row mb-6">
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="kbuildingName" class="form-control" placeholder="건물명"
                                    value="{{ old('kbuildingName') }}" />
                                <x-input-error class="mt-2 text-danger" :messages="$errors->get('kbuildingName')" />
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="bjdCode" readonly class="form-control form-control-solid"
                                    placeholder="법정동코드" value="{{ old('bjdCode') }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="as1" readonly class="form-control form-control-solid" placeholder="시도"
                                    value="{{ old('as1') }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="as2" readonly class="form-control form-control-solid" placeholder="시군구"
                                    value="{{ old('as2') }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="as3" readonly class="form-control form-control-solid" placeholder="읍면동"
                                    value="{{ old('as3') }}" />
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="as4" readonly class="form-control form-control-solid" placeholder="리"
                                    value="{{ old('as4') }}" />
                            </div>
                        </div>
                            ...
                            <div class="col-lg-9 fv-row row">
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="subwayStation" class="form-control"
                                            placeholder="역 명" value="{{ old('subwayStation') }}" />
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="subwayLine" class="form-control"
                                            placeholder="호선" value="{{ old('subwayLine') }}" />
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="kbuildingdWtimesub" class="form-control"
                                            placeholder="" value="{{ old('kbuildingdWtimesub') }}" />
                                    </div>
                                </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-3 fv-row">
                                <div class="input-group">
                                    <span class="input-group-text" id="basic-addon2">이동 시간</span>
                                    <input type="text" name="kbuildingdWtimebus" class="form-control" placeholder=""
                                        value="{{ old('kbuildingdWtimebus') }}" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9 fv-row">
                                <textarea name="convenientFacility" class="form-control mb-5" rows="5"
                                    placeholder="주변 편의시설, 역세권 등의 정보를 입력해주세요.">{{ old('convenientFacility') }}</textarea>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-9 fv-row">
                                <textarea name="educationFacility" class="form-control  mb-5" rows="5" placeholder="주변 교 시설을 입력하세요.">{{ old('educationFacility') }}</textarea>
