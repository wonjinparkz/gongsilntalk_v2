                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="kbuildingName" class="form-control" placeholder="건물명"
                                    value="{{ old('kbuildingName') ?? $result->kbuildingName }}" />
                                ...
                                <div class="col-lg-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="kbuildingdWtimesub" class="form-control"
                                            placeholder=""
                                            value="{{ old('kbuildingdWtimesub') ?? $result->kbuildingdWtimesub }}" />
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-3 fv-row">
                                <div class="input-group">
                                    ...
                                    <input type="text" name="kbuildingdWtimebus" class="form-control"
                                        placeholder=""
                                        value="{{ old('kbuildingdWtimebus') ?? $result->kbuildingdWtimebus }}" />
                                </div>
                            </div>
                        </div>
