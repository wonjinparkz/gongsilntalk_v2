<x-admin-layout>
            ...
            <x-screen-card :title="'기본 정보'">
                ...
                <div class="card-body border-top p-9">
                            ...
                            @for ($i = 0; $i < count(Lang::get('commons.site_product_region_type')); $i++)
                                <label class="form-check form-check-custom form-check-inline me-1 p-1 form-check-sm">
                                    <input class="form-check-input" name="region_type" type="radio"
                                        value="{{ $i }}" @if (old('region_type') ?? $result->region_type == $i) checked @endif>
                                    <span
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <textarea name="contents" class="form-control mb-5" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents') ?? $result->contents }}</textarea>
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group mb-5">
                                <input type="text" name="min_floor" class="form-control" placeholder="최저"
                                    value="{{ old('min_floor') ?? $result->min_floor }}" />
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group mb-5">
                                <input type="text" name="max_floor" class="form-control" placeholder="최고"
                                    value="{{ old('max_floor') ?? $result->max_floor }}" />
                                <span class="input-group-text" id="basic-addon2">층</span>
                            </div>
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group mb-5">
                                <input type="number" name="dong_count" class="form-control" placeholder="총 동수"
                                    value="{{ old('dong_count') ?? $result->dong_count }}" />
                        ...
                        <div class="col-lg-3 d-flex align-items-center">
                            <div class="input-group mb-5">
                                <input type="number" name="parking_count" class="form-control" placeholder=""
                                    value="{{ old('parking_count') ?? $result->parking_count }}" />
                        ...
                        <div class="col-lg-3 d-flex align-items-center">
                            <div class="input-group mb-5">
                                <input type="number" name="generation_count" class="form-control" placeholder=""
                                    value="{{ old('generation_count') ?? $result->generation_count }}" />
                                <span class="input-group-text" id="basic-addon2">대</span>
                            </div>
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group">
                                <input type="number" name="area" id="area" class="form-control"
                                    placeholder="변환 버튼을 눌러주세요." value="{{ old('area') ?? $result->area }}" />
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group">
                                <input type="text" name="square" id="square" class="form-control"
                                    ...
                                    value="{{ old('square') ?? $result->square }}" />
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group">
                                <input type="number" name="building_area" id="building_area" class="form-control"
                                    ...
                                    value="{{ old('building_area') ?? $result->building_area }}" />
                                <span class="input-group-text" id="basic-addon2">평</span>
                            </div>
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group">
                                <input type="text" name="building_square" id="building_square"
                                    ...
                                    value="{{ old('building_square') ?? $result->building_square }}" />
                                <span class="input-group-text" id="basic-addon2">㎡</span>
                            </div>
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group">
                                <input type="number" name="total_floor_area" id="total_floor_area"
                                    ...
                                    value="{{ old('total_floor_area') ?? $result->total_floor_area }}" />
                                <span class="input-group-text" id="basic-addon2">평</span>
                            </div>
                        ...
                        <div class="col-lg-3 fv-row">
                            <div class="input-group">
                                <input type="text" name="total_floor_square" id="total_floor_square"
                                    onkeyup="imsi(this)" class="form-control" placeholder="변환 버튼을 눌러주세요."
                                    value="{{ old('total_floor_square') ?? $result->total_floor_square }}" />
                                <span class="input-group-text" id="basic-addon2">㎡</span>
                            </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="developer" class="form-control" placeholder="시행사"
                                value="{{ old('developer') ?? $result->developer }}" />
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="comstruction_company" class="form-control" placeholder="시공사"
                                value="{{ old('comstruction_company') ?? $result->comstruction_company }}" />
            ...
            <x-screen-card :title="'교육 자료'">
                ...
                <div class="card-body border-top p-9">
                    <x-admin-image-picker :title="'교육 자료'" required="required" cnt='10' id="siteProductEdu"
                        label_col='2' div_col='9' :images="$result->edu_images" />
            ...
            <x-screen-card :title="'층별 정보'">
                ...
                <div class="card-body border-top p-9">
                    <div class="dong-container">
                        @foreach (old('dong_info', $result->dongInfo) as $dongIndex => $dongInfo)
                            <div class="row mb-6 dong_row" data-index="{{ $dongIndex }}">
                                ...
                                <div class="col-lg-12 row mb-6">
                                    ...
                                    <div class="col-lg-10 fv-row floor-container"
                                        ...
                                        @foreach (old('dong_info')[$dongIndex]['floor_info'] ?? $result->dongInfo[$dongIndex]->floorInfo as $floorIndex => $floorInfo)
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="title_1" class="form-control mb-1" placeholder="프리미엄 제목 입력"
                                value="{{ old('title_1') ?? $result->premiumInfo->title_1 }}" />
                            <textarea name="contents_1" class="form-control" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents_1') ?? $result->premiumInfo->contents_1 }}</textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="title_2" class="form-control mb-1" placeholder="프리미엄 제목 입력"
                                value="{{ old('title_2') ?? $result->premiumInfo->title_2 }}" />
                            <textarea name="contents_2" class="form-control" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents_2') ?? $result->premiumInfo->contents_2 }}</textarea>
                        </div>
                        ...
                        <div class="col-lg-9 fv-row d-flex align-items-center">
                            <label class="form-check form-check-custom form-check-inline p-1">
                                <input class="form-check-input" name="is_blind_1" id="is_blind_1" type="checkbox"
                                    value="1" @if (old('is_blind_1', $result->premiumInfo->is_blind_1)) checked @endif>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="title_3" class="form-control mb-1" placeholder="프리미엄 제목 입력"
                                value="{{ old('title_3') ?? $result->premiumInfo->title_3 }}" />
                            <textarea name="contents_3" class="form-control" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents_3') ?? $result->premiumInfo->contents_3 }}</textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="title_4" class="form-control mb-1" placeholder="프리미엄 제목 입력"
                                value="{{ old('title_4') ?? $result->premiumInfo->title_4 }}" />
                            <textarea name="contents_4" class="form-control" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents_4') ?? $result->premiumInfo->contents_4 }}</textarea>
                        </div>
                        ...
                        <div class="col-lg-9 fv-row d-flex align-items-center">
                            <label class="form-check form-check-custom form-check-inline p-1">
                                <input class="form-check-input" name="is_blind_2" id="is_blind_2" type="checkbox"
                                    value="1" @if (old('is_blind_2', $result->premiumInfo->is_blind_2)) checked @endif>
                                <span class="fw-semibold ps-2 fs-6">노출안함</span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="title_5" class="form-control mb-1" placeholder="프리미엄 제목 입력"
                                value="{{ old('title_5') ?? $result->premiumInfo->title_5 }}" />
                            <textarea name="contents_5" class="form-control" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents_5') ?? $result->premiumInfo->contents_5 }}</textarea>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="title_6" class="form-control mb-1" placeholder="프리미엄 제목 입력"
                                value="{{ old('title_6') ?? $result->premiumInfo->title_6 }}" />
                            <textarea name="contents_6" class="form-control" rows="5" placeholder="세부내용 입력해주세요.">{{ old('contents_6') ?? $result->premiumInfo->contents_6 }}</textarea>
                        </div>
    ...
    <div class="card-footer d-flex justify-content-end py-6 px-9">
        <button type="buttion" class="btn btn-primary" onclick="formSubmit();">수정</button>
    </div>
    {{-- Footer END --}}
