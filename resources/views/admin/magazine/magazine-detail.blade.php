        ...
        <x-screen-card :title="'매거진 상세'">
            ...
            <form class="form" method="POST" action="{{ route('admin.magazine.update') }}">
                ...
                <div class="card-body border-top p-9">
                    ...
                    {{-- 이미지 --}}
                    <x-admin-image-picker :title="'매거진 이미지'" :id="'magazine'" :images="$result->images" />
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-4 d-flex align-items-center">
                            @php
                                $magazineCategoryId = old('magazine_category_id') ?? $result->magazine_category_id;
                            @endphp
