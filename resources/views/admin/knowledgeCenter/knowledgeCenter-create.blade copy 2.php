                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <a onclick="getAddress()" class="btn btn-outline mb-md-5"
                                    ...
                                    주소 검색 </a>
                            <input type="text" name="title" class="form-control form-control-solid " readonly
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="developer" class="form-control form-control-solid"
                                placeholder="시행사명 입력" value="{{ old('developer') }}" />
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <textarea name="traffic_info" class="form-control form-control-solid mb-5" rows="5"
                                placeholder="주변 교통관련 정보를 입력해주세요.">{{ old('traffic_info') }}</textarea>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <textarea name="site_contents" class="form-control form-control-solid mb-5" rows="5"
                                placeholder="주변 편의시설, 역세권 등의 정보를 입력해주세요.">{{ old('site_contents') }}</textarea>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <input type="text" name="comments" class="form-control form-control-solid"
                                placeholder="40자 내로 한줄 요약을 입력해주세요." value="{{ old('comments') }}" />
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <textarea name="bus_stop_contents" class="form-control form-control-solid mb-5" rows="5"
                                placeholder="버스 정류장과의 거리를 입력하세요.">{{ old('bus_stop_contents') }}</textarea>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-9 fv-row">
                            <textarea name="facilities_contents" class="form-control form-control-solid mb-5" rows="5"
                                placeholder="주변 편의 시설을 입력하세요.">{{ old('facilities_contents') }}</textarea>
