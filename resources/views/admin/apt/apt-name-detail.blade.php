<x-admin-layout>
    ...
    <form class="form" method="POST" action="{{ route('admin.apt.name.create') }}">
        ...
        <div class="app-container container-xxl">
            <x-screen-card :title="'아파트 단지명 상세'">
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-5 fv-row">
                            <select class="form-select form-select-solid" name="apt_id" id="apt_id"
                                data-control="select2" data-placeholder="단지명으로 검색">
                                <option></option>
                                <option value="{{$result->id}}">{{$result->kaptName}}</option>
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-5 fv-row">
                            ...
                            <div class="form-group mt-5 complex_preview">
                                @php
                                    $complexName = explode(',', $result->complex_name);
                                @endphp
                                @foreach (old('complex_name', $complexName) as $aptComplex)
                                    <div class="row">
                                        <div class="col-md-8">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('select[name="apt_id"]').val('{{ $result->id }}').trigger('change');
        })
        // 유사 단지명 추가
