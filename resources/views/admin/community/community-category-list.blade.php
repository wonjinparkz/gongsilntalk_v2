        ...
        <div class="app-toolbar py-3 py-lg-6">
            <div class="app-container container-xxl d-flex flex-stack">
                ...
                <div class="d-inline-block position-relative">
                    <h1 class="page-heading d-flex text-dark fw-bold fs-5ts flex-column justify-content-center ">커뮤니티
                        카테고리
                    </h1>
                    <span
            ...
            <div class="app-container container-xxl">
                ...
                <div class="card card-flush shadow-sm">
                    <form class="form card-body row border-top p-9 align-items-center" method="GET"
                        action="{{ route('admin.community.category.list.view') }}">
                        @csrf

                        {{-- 제목 --}}
                        <div class="col-lg-6 row mb-6">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">카테고리 제목</label>
                        ...
                        {{-- 작성일 --}}
                        <div class="col-lg-6 row mb-6">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">카테고리 등록일</label>
                            <div class="col-lg-8 fv-row">
                                {{-- 데이트 피커 --}}
                        ...
                        {{-- 상태 선택 --}}
                        <div class="col-lg-6 row mb-6">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">카테고리 상태</label>
                            @php
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center">
                                                <a href="{{ route('admin.community.category.detail.view', [$category->id]) }}"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $category->title }}</a>

                                                @if ($category->images != null && count($category->images) > 0)
                                                    <div class="ms-2 badge badge-light-success">
                                                        이미지 {{ count($category->images) }} 개
                                                    </div>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <span class="fw-bold fs-5">
                                                ...
                                                {{ $carbon::parse($category->created_at)->format('Y년 m월 d일 H:i:s') }}
                                            </span>
                                        </td>
                                        {{-- 동작 : 수정, 삭제 --}}
                                        <td class="text-center">
                                            ...
                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                                ...
                                                <div class="menu-item px-3">
                                                    <form action="{{ route('admin.community.category.update.state') }}"
                                                        method="POST">
                                                        @csrf
                                                ...
                                                <div class="menu-item px-3">
                                                    <form id="deleteCategory{{ $category->id }}"
                                                        action="{{ route('admin.community.category.delete') }}"
                                                        method="POST">
                                                        @csrf
                                                        <input type="hidden" name="id"
                                                            value="{{ $category->id }}" />
