                ...
                <div class="card card-flush shadow-sm">
                    <form class="form card-body row border-top p-9 align-items-center" method="GET"
                        ...
                        <div class="col-lg-6 row mb-6">
                            <label class="col-lg-4 col-form-label fw-semibold fs-6">팝업 제목</label>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                @foreach ($result as $popup)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <a href="{{ route('admin.popup.detail.view', [$popup->id]) }}"
                                                    class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $popup->title }}</a>
                                                @if ($popup->images != null && count($popup->images) > 0)
                                                    <div class="ms-2 badge badge-light-success">
                                                        이미지 {{ count($popup->images) }} 개
                                                    </div>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        {{-- 팝업 내용 --}}
                                        <td class="text-center">
                                            <span class="fw-bold fs-5">{{ $popup->content }}</span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <span class="fw-bold fs-5">
                                                ...
                                                {{ $carbon::parse($popup->started_at)->format('Y년 m월 d일') }} ~
                                                {{ $carbon::parse($popup->ended_at)->format('Y년 m월 d일') }}
                                            </span>
                                        </td>
                                        ...
                                        <td class="text-center">
                                            <span class="fw-bold fs-5">
                                                @inject('carbon', 'Carbon\Carbon')
                                                {{ $carbon::parse($popup->created_at)->format('Y년 m월 d일 H:i:s') }}
                                            </span>
                                        </td>
                                        {{-- 동작 : 수정, 삭제 --}}
                                        <td class="text-center">
