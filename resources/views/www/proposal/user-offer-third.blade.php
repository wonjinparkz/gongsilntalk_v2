<x-layout>
    ...
    <div class="body">
        <form method="post" action="{{ route('www.mypage.user.offer.create') }}" id="create_form" name="create_form">
                ...
                <div class="offer_step_wrap">
                    <div class="box_01 box_reg">
                        ...
                        @if ($request->type == 0)
                            ...
                            <div>
                                ...
                                <div class="btn_radioType">
                                    <input type="radio" name="floor" id="floor_1" value="0" checked>
                                    <label for="floor_1">상관없음</label>

                                    <input type="radio" name="floor" id="floor_2" value="1">
                                    <label for="floor_2">1층</label>

                                    <input type="radio" name="floor" id="floor_3" value="2">
                        ...
                        <div>
                            ...
                            <div class="btn_radioType">
                                <input type="radio" name="interior" id="interior_1" value="0" checked>
                                <label for="interior_1">선택 안함</label>

                                <input type="radio" name="interior" id="interior_2" value="1">
                                <label for="interior_2">필요해요</label>

                                <input type="radio" name="interior" id="interior_3" value="2">
                        ...
                        <div class="offer_textarea_wrap">
                            ...
                            <textarea id="content" name="content" placeholder="요청사항이 있는 경우 입력해주세요."></textarea>
                        </div>
                    </div>
                    ...
                    <div class="step_btn_wrap">
                        ...
                        <button class="btn_full_basic btn_point" type="submit">제안서
                            받아보기</button>
                    </div>
