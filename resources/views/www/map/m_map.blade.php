<html lang="kor"><head>
  ...
  <body>
    ...
    <div class="map_m_top_wrap only_m">
        <div class="m_inner_wrap">
            <div class="community_search_wrap flex_between">
                ...
                <button onclick="location.href='community_search_list.html'"><img src="images/btn_search.png" alt="검색"></button>
           </div>
        </div>
        ...
        <div class="inner_wrap">
            <div class="swiper detail_tab m_swiper_filter">
                <div class="swiper-wrapper menu">
                  <div class="swiper-slide active"><button class="filter_btn_trigger" onclick="modal_open_slide('filter_1')">매물 종류</button></div>
                  <div class="swiper-slide"><button class="filter_btn_trigger" onclick="modal_open_slide('filter_2')">거래유형/가격</button></div>
                </div>
            </div>
        </div>
    <!-- tab : e -->
    ...
    <div class="modal_slide modal_slide_filter_1">
        <div class="slide_title_wrap">
            <span>매물 종류</span>
            <img src="images/btn_md_close.png" onclick="modal_close_slide('filter_1')">
        </div>
    ...
    <div class="modal_slide modal_slide_filter_2">
        <div class="slide_title_wrap">
            <span>융자금</span>
            <img src="images/btn_md_close.png" onclick="modal_close_slide('filter_2')">
        </div>
        <div class="slide_modal_body">
            <div class="btn_radioType">
                <input type="radio" name="year" id="year_1" value="Y"> 
