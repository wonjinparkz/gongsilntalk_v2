        ...
        <div class="map_wrap">
            ...
            <div class="map_body">
                    ...
                    <div class="scroll_wrap_1">
                        ...
                        <div class="estate_link">
                            <a href="#" class="flex_between">
                                <span><img src="{{ asset('assets/media/ic_org_estate.png') }}" class="ic_left_20">
                                    부동산 내놓기</span>
                            ...
                            <div style="width: 100%;">
                                <div class="swiper detail_tab">
                                    <div class="swiper-wrapper menu toggle_menu">
                                        ...
                                        <div class="swiper-slide"><a href="javascript:(0)"
                                                onclick="showContent(1)">건물·토지정보</a></div>
                                        <div class="swiper-slide"><a href="javascript:(0)"
                                                onclick="showContent(2)">위치 및 주변정보</a></div>
                                        <div class="swiper-slide"><a href="javascript:(0)"
                                                onclick="showContent(3)">매물정보</a></div>
                                    </div>
                                </div>
                        ...
                        <div class="side_tab_wrap">
                                ...
                                <div class="side_section">
                                    ...
                                    <div class="mt20">
                                        ...
                                        <div class="transaction_box mt10">
                                            <div class="gray_deep"><span class="transaction_price">3억
                                                    8200만</span>(11층)</div>
                            ...
                            <div class="sction_item">
                                ...
                                <div class="side_section">
                                    <h4>위치 및 주변정보</h4>
                                    <div class="container_map_wrap mt18"><img
                                            src="{{ asset('assets/media/s_map.png') }}" class="w_100">
                                    </div>
                            ...
                            <div class="sction_item">
                                <div class="side_section">
                                    <div class="flex_between">
                                        <h4>매물정보</h4>
                                        <button class="btn_xs btn_gray btn_all"
                                            onclick="location.href='property_map.html'">매물 더보기<img
                ...
                <div class="map_area">
                    ...
                    <script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpClientId={{env('VITE_NAVER_MAP_CLIENT_ID')}}"></script>
