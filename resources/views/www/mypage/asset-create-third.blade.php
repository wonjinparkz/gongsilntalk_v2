<x-layout>
    ...
    <div class="body">
        ...
        <div class="inner_mid_wrap m_inner_wrap mid_body">
            <h1 class="t_center only_pc">자산 등록하기 <span class="step_number"><span class="txt_point">3</span>/4</span></h1>
            ...
            <div class="offer_step_wrap">
                ...
                <div class="step_btn_wrap">
                    <button class="btn_full_basic btn_graylight_ghost"
                        onclick="location.href='{{ route('www.mypage.service.create.second.view')}}'">이전</button>
                    <!-- <button class="btn_full_basic btn_point" disabled>다음</button> 정보 입력하지 않았을때 disabled 처리 필요. -->
                    <button class="btn_full_basic btn_point" onclick="location.href='{{ route('www.mypage.service.create.fourth.view')}}'">다음</button>
                </div>
