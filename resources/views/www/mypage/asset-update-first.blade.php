                                    ...
                                    <div class="flex_2">
                                        <div class="flex_1">
                                            <input type="text" id="address_dong" name="address_dong"
                                                {{ $result->address_dong == '' ? 'disabled' : '' }}
                                                value="{{ $result->asset_address->is_temporary == 0 ? $result->address_dong : '' }}">
                                            <span>동</span>
                                        </div>
                                        <div class="flex_1">
...
<script>
    ...
    $(document).ready(function() {
        ...
        if ('{{ $result->asset_address->is_is_temporary }}' == 1) {
            $("#temporary_address").trigger('click');
        }
