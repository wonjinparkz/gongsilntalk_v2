<x-layout>
    <!----------------------------- m::header bar : s ----------------------------->
    <div class="m_header">
        <div class="left_area"><a href="my_main.html"><img src="{{ asset('assets/media/header_btn_back.png') }}"></a></div>
    ...
    <div class="body">
        ...
        <div class="my_inner_wrap">
            <div class="my_wrap">
                ...
                <div class="my_body inner_wrap m_inner_wrap">
                    ...
                    <div class="my_tab_wrap">
                        <ul class="tab_type_5">
                            <li class="active" onclick="location.href='calculator_revenue.html'">수익률 계산</li>
                            <li onclick="location.href='calculator_loan.html'">대출이자 계산</li>
                        </ul>
                    </div>
            ...
            <div class="modal modal_mid modal_rev_calculator">
                ...
                <div class="md_inner_scroll">
                    ...
                    <ul class="reg_bascic mt18">
                        ...
                        <li>
                            ...
                            <div class="flex_1">
                                <input type="text" placeholder="0 ~ 100 사이값 입력">
                                <span>%</span>
                            </div>
                        </li>
                        <li>
                            <label>대출금리</label>
                            <div class="flex_1">
                                <input type="text" placeholder="소수점 두자리까지 입력">
                                <span>%</span>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="modal_container">
                    <button class="btn_point btn_full_basic" disabled><b>수익률 계산하기</b></button>
                </div>
