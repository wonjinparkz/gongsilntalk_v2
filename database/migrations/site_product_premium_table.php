...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('site_product_premium', function (Blueprint $table) {
            ...
            $table->string('title_3')->nullable()->comment("프리미엄 3 제목");
            $table->string('title_4')->nullable()->comment("프리미엄 4 제목");
            $table->string('title_5')->nullable()->comment("프리미엄 5 제목");
            $table->string('title_6')->nullable()->comment("프리미엄 6 제목");
            $table->longText('contents_1')->comment('프리미엄 1 내용');
            $table->longText('contents_2')->comment('프리미엄 2 내용');
