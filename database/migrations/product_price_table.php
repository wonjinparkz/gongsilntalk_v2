...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('product_price', function (Blueprint $table) {
            ...
            $table->bigInteger('price')->nullable()->comment('매매 - 매매가, 전세 - 전세가, 전매 - 전매가, 월세&단기임대&임대 - 보증금');
            $table->bigInteger('month_price')->nullable()->comment('월세 - 월세, 단기임대&임대 -월임대료');
            ...
            $table->bigInteger('current_price')->nullable()->comment('현재 매물 보증금');
            $table->bigInteger('current_month_price')->nullable()->comment('현재 매물 월임대료');
