...
(function($){
    ...
    $.fn.tagEditor = function(options, val, blur){
        ...
        return selector.each(function(){
            ...
            // keypress delimiter for android
            var inp_a;
            ed.on('textInput', 'input', function(e){
                if(o.delimiter.indexOf(String.fromCharCode(e.originalEvent.data.charCodeAt(0)))>=0) {
                    inp_a = $(this);
                    setTimeout(function(){ split_cleanup(inp_a); }, 20);
                }
            });
